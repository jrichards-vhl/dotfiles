...
" Git - show changed lines in gutter.
...
hi Pmenu ctermbg=black ctermfg=148
hi PmenuSel ctermbg=148 ctermfg=black
...
syntax on
set hlsearch
highlight Visual cterm=NONE ctermbg=19
highlight Search cterm=NONE ctermbg=19 ctermfg=220
highlight Error cterm=NONE ctermbg=0 ctermfg=red
...
" coc-volar select from dropdown with Enter key
